	...
	return (
		<header {...props} className="py-12 px-12 md:px-16 lg:px-20">
			<div className="flex items-center">
				...
				<div className="pl-6">
					<h1 className="font-display text-hero shadow-sharp-2 shadow-hero mb-1 bg-white py-[0.4px] px-[12px] text-2xl font-normal uppercase [text-shadow:1px_1px_0px_black]">
						Governance
					</h1>
					<h2 className="font-body text-hero shadow-sharp-2 shadow-hero inline-block bg-white py-[0.4px] px-[12px] uppercase [text-shadow:1px_1px_0px_black]">
						Platform
					</h2>
				</div>
			</div>
